				...
				<div class="col-md-6 col-lg-4">
					<div class="login-wrap p-0">
						...
						<form action="{{ route('user.register') }}" class="signin-form" method="POST">
							...
							<div class="form-group">
								<input type="text" name="phone" id="phone" class="form-control" placeholder="Nomor HP" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input id="password-field" type="password" name="conf_password" class="form-control" placeholder="Konfirmasi Password" required>
								<span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
							</div>
							<div class="form-group">
